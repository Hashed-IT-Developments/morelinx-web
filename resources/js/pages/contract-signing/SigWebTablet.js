...
function SigWebcreateXHR() {
	try { return new XMLHttpRequest(); } catch (e) { console.log(e.toString() ) }
	try { return new window.ActiveXObject("Msxml2.XMLHTTP.6.0"); } catch (e) { console.log(e.toString() ) }
	try { return new window.ActiveXObject("Msxml2.XMLHTTP.3.0"); } catch (e) { console.log(e.toString() ) }
	try { return new window.ActiveXObject("Msxml2.XMLHTTP"); } catch (e) { console.log(e.toString() ) }
	try { return new window.ActiveXObject("Microsoft.XMLHTTP"); } catch (e) { console.log(e.toString() ) }
