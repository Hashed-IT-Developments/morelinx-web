...
export default function CreateRouteDialog({ onOpenChange, open, selectedBarangay, meterReaders, onCreate }: CreateRouteProps) {
    ...
    const onCreateRoute = () => {
        ...
        if (!selectedBarangay || !selectedDayOfMonth || !routeName) {
            alert('Please fill in all required fields.');
            return;
        }

        axios
            .post(route('mrb.routes.create-route-api'), {
            ...
            <DialogContent className="w-full md:min-w-xl">
                ...
                <div className="mt-4 flex flex-col gap-4">
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        <button type="button" className="rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700" onClick={onCreateRoute}>
                            Create Route
                        </button>
                    </div>
                </div>
