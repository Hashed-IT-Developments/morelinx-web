...
/**
 * Returns appropriate CSS classes for approval status badge styling
 * Provides consistent color coding for approval-specific statuses
 * @param status - The approval status string to style
 * @returns CSS class string for approval badge styling
 */
